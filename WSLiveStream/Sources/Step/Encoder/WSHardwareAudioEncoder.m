...
@interface WSHardwareAudioEncoder (){
...
@property (nonatomic, strong) WSLiveAudioConfiguration *configuration;
@property (nonatomic, weak) id<WSAudioEncodingDelegate> aacDeleage;

@end

@implementation WSHardwareAudioEncoder
...
- (void)setDelegate:(id<WSAudioEncodingDelegate>)delegate {
