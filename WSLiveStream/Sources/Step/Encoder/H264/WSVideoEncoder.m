...
#import "WSVideoEncoder.h"

@implementation WSVideoEncoder
{
...
+ (WSVideoEncoder *)encoderForPath:(NSString *)path Height:(int)height andWidth:(int)width bitrate:(int)bitrate {
    WSVideoEncoder *enc = [WSVideoEncoder alloc];
