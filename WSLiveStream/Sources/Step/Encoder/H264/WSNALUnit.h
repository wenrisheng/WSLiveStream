...
public:
    WSNALUnit();
    WSNALUnit(const BYTE* pStart, int len){
    ...
    WSNALUnit(const WSNALUnit &r){
        m_pStart = r.m_pStart;
        m_cBytes = r.m_cBytes;
        ResetBitstream();
    }
    const WSNALUnit& operator = (const WSNALUnit &r)
    {
        m_pStart = r.m_pStart;
        m_cBytes = r.m_cBytes;
        ResetBitstream();
