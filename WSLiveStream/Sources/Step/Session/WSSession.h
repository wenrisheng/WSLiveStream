...
/**
   ...
   capture unstable.
 */
- (nullable instancetype)initWithAudioConfiguration:(nullable WSLiveAudioConfiguration *)audioConfiguration videoConfiguration:(nullable WSLiveVideoConfiguration *)videoConfiguration;

/**
 The designated initializer. Multiple instances with the same configuration will make the
 capture unstable.
 */
- (nullable instancetype)initWithAudioConfiguration:(nullable WSLiveAudioConfiguration *)audioConfiguration videoConfiguration:(nullable WSLiveVideoConfiguration *)videoConfiguration captureType:(LFLiveCaptureTypeMask)captureType NS_DESIGNATED_INITIALIZER;

/** The start stream .*/
- (void)startLive:(nonnull WSLiveStreamInfo *)streamInfo;
